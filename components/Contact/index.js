...
function Contact() {
  ...
  return (
    <div className='bg-dracula-cyan min-h-screen flex lg:flex-row lg:justify-between items-center justify-center flex-col' id='contact'>
      <div className="py-12 md:px-12">
        <div className="container mx-auto xl:px-32">
          <div className="grid items-center lg:grid-cols-2">
            <div className="mb-12 md:mt-12 lg:mt-0 lg:mb-0">
              <div
                className="relative z-[1] block rounded-lg bg-[hsla(0,0%,100%,0.55)] px-6 py-12 shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] backdrop-blur-[30px] md:px-12 lg:-mr-14"
              >
                <h2 className="mb-12 text-3xl font-bold text-skin-base-light">Any Questions? <span className='text-dracula-green'>Tell Us!</span></h2>
                <form>
      ...
      {/* Right */}
      <div class="w-full shrink-0 grow-0 basis-auto lg:w-7/12 xl:w-5/12">
        <div class="flex flex-wrap">
          <div class="mb-12 w-full shrink-0 grow-0 basis-auto md:w-6/12 md:px-3 lg:w-full lg:px-6 xl:w-6/12">
            <div class="flex items-start bg-dracula-foreground border rounded border-dracula-background">
              <div class="shrink-0">
          ...
          <div
            ...
            <div class="align-start flex bg-dracula-foreground border rounded border-dracula-background">
              <div class="shrink-0">
                <div class="inline-block rounded-md bg-primary-100 p-4 text-primary">
                  <Icon
